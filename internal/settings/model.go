...
var Defs = []KeyDef{
	...
	{Key: ImageGenBaseURL, Type: "url", Category: "imagegen", Default: "http://ai.reeko.net.cn/v1", Label: "Base URL", Desc: "OpenAI 兼容 /v1 地址"},
	...
	{Key: TextGenBaseURL, Type: "url", Category: "textgen", Default: "http://ai.reeko.net.cn/v1", Label: "Base URL", Desc: "OpenAI 兼容 /v1 地址"},
