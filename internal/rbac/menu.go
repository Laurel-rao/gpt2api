...
var menuTree = []Menu{
	// ---- 普通用户区 ----
	{
		...
		Children: []Menu{
			...
			{Key: "personal.guide", Title: "系统指南", Icon: "Guide", Path: "/personal/guide",
				Perms: []Permission{PermSelfProfile}},
			{Key: "personal.ecommerce-v2", Title: "电商智能体", Icon: "ShoppingBag", Path: "/personal/ecommerce-v2",
				Perms: []Permission{PermSelfEcommerce}},
			{Key: "personal.ecommerce-canvas", Title: "电商画布", Icon: "Operation", Path: "/personal/ecommerce-canvas",
				Perms: []Permission{PermSelfEcommerce}},
			{Key: "personal.ecommerce-assets", Title: "电商资产库", Icon: "Collection", Path: "/personal/ecommerce-assets",
				Perms: []Permission{PermSelfEcommerce}},
			{Key: "personal.ecommerce-mobile", Title: "电商移动工作台", Icon: "Cellphone", Path: "/personal/ecommerce-mobile",
				Perms: []Permission{PermSelfEcommerce}},
			{Key: "personal.video-workflows", Title: "视频工作流", Icon: "VideoPlay", Path: "/personal/video-workflows",
				Perms: []Permission{PermSelfVideoWorkflow}},
			{Key: "personal.docs", Title: "接口文档", Icon: "Document", Path: "/personal/docs",
				Perms: []Permission{PermSelfKey, PermSelfUsage, PermSelfImage}},
		},
	},
	// ---- 管理员区 ----
	{
		...
		Children: []Menu{
			...
			{Key: "admin.image-tasks", Title: "生成记录", Icon: "Picture", Path: "/admin/image-tasks",
				Perms: []Permission{PermUsageReadAll}},
			{Key: "admin.ecommerce-platforms", Title: "电商平台", Icon: "ShoppingBag", Path: "/admin/ecommerce-platforms",
				Perms: []Permission{PermEcommerceManage}},
			{Key: "admin.ecommerce-prompts", Title: "提示词模板", Icon: "Tickets", Path: "/admin/ecommerce-prompts",
				Perms: []Permission{PermEcommerceManage}},
			{Key: "admin.ecommerce-styles", Title: "风格模板", Icon: "Brush", Path: "/admin/ecommerce-styles",
				Perms: []Permission{PermEcommerceManage}},
			{Key: "admin.ecommerce-assets", Title: "电商资产审核", Icon: "Collection", Path: "/admin/ecommerce-assets",
				Perms: []Permission{PermEcommerceManage}},
