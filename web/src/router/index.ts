...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'keys', redirect: (to) => ({ path: '/personal/docs', query: { ...to.query, tab: 'keys' } }) },
      ...
      { path: 'guide', component: () => import('@/views/personal/SystemGuide.vue'),
        meta: { title: '系统指南', perm: 'self:profile' } },
      ...
      { path: 'docs', component: () => import('@/views/personal/ApiDocs.vue'),
        meta: { title: '接口文档', perm: ['self:key', 'self:usage', 'self:image'] } },
      // 旧路径兼容
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ecommerce-platforms', component: () => import('@/views/admin/EcommercePlatforms.vue'),
        meta: { title: '电商平台', perm: 'ecommerce:manage' } },
      { path: 'ecommerce-prompts', component: () => import('@/views/admin/EcommercePrompts.vue'),
